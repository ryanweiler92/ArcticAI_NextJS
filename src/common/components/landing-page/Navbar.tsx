...
const Navbar = () => {
  ...
  return (
    <Flex justify="center" borderBottom={'4px'} borderColor="tan.200" pb="2">
      <Box width={{ base: '100%', sm: '100%', lg: '60%' }}>
        <Flex
          bg={'brand.800'}
          color={'white'}
          minH={'7vh'}
        ...
        >
          ...
          <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'start' }}>
            <Image src={logo} width={'50'} alt={'Arctic AI Logo'} />
